...
const stepsToExclude = [
    'NewStartEligibility', 'NewDeathCertificate', 'NewDeceasedDomicile', 'NewIhtCompleted', 'NewWillLeft', 'NewWillOriginal', 'NewApplicantExecutor', 'NewMentalCapacity', 'NewStartApply',
    'StartEligibility', 'DeathCertificate', 'DeceasedDomicile', 'IhtCompleted', 'WillLeft', 'WillOriginal', 'ApplicantExecutor', 'MentalCapacity', 'StartApply',
    'Summary', 'TaskList',
    'PinPage', 'PinSent', 'PinResend', 'AddressLookup', 'ExecutorAddress', 'ExecutorContactDetails', 'ExecutorName', 'ExecutorNotified', 'ExecutorNameAsOnWill', 'ExecutorApplying', 'DeleteExecutor', 'PaymentStatus', 'AddAlias', 'RemoveAlias', 'ExecutorRoles', 'ExecutorsWhenDied'];
