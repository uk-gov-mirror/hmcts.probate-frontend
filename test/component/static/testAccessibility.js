    ...
    describe('Verify Content, Errors and Redirection', () => {
        it('test right content loaded on the page', (done) => {
            const contentData = {
                ...
                hmctAccessAccessibilityStatement: config.links.hmctAccessAccessibilityStatement,
                payAccessibilityStatement: config.links.payAccessibilityStatement,
                notifyAccessibilityStatement: config.links.notifyAccessibilityStatement,
