...
describe('stop-page', () => {
    ...
    describe('Verify Content, Errors and Redirection', () => {
        it('test right content loaded on the page - no death certificate', (done) => {
            ...
            const excludeKeys = ['notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
        ...
        it('test right content loaded on the page - deceased not in england or wales', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
        ...
        it('test right content loaded on the page - iht not completed', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
        ...
        it('test right content loaded on the page - no will', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
        ...
        it('test right content loaded on the page - not original', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
            testWrapper.testContent(done, excludeKeys, {applicationFormPA1P: config.links.applicationFormPA1P, applicationFormPA1A: config.links.applicationFormPA1A});
        });
        ...
        it('test right content loaded on the page - not executor', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
        ...
        it('test right content loaded on the page - mental capacity', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
        ...
        it('test right content loaded on the page - not died after october 2014', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
        ...
        it('test right content loaded on the page - not related', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'otherApplicants', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
            testWrapper.testContent(done, excludeKeys, {applicationFormPA1A: config.links.applicationFormPA1A});
        });
        ...
        it('test right content loaded on the page - other applicants', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'divorcePlace', 'otherRelationship', 'adoptionNotEnglandOrWales'];
            testWrapper.testContent(done, excludeKeys, {applicationFormPA1A: config.links.applicationFormPA1A});
        });
        ...
        it('test right content loaded on the page - divorce not in england or wales', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'otherRelationship', 'adoptionNotEnglandOrWales'];
            testWrapper.testContent(done, excludeKeys, {applicationFormPA1A: config.links.applicationFormPA1A});
        });
        ...
        it('test right content loaded on the page - applicant is not spouse, civil partner or child of deceased', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'adoptionNotEnglandOrWales'];
            testWrapper.testContent(done, excludeKeys, {applicationFormPA1A: config.links.applicationFormPA1A});
        });
        ...
        it('test right content loaded on the page - adoption not in england or wales', (done) => {
            ...
            const excludeKeys = ['deathCertificate', 'notInEnglandOrWales', 'ihtNotCompleted', 'noWill', 'notOriginal', 'notExecutor', 'mentalCapacity', 'notDiedAfterOctober2014', 'notRelated', 'otherApplicants', 'divorcePlace', 'otherRelationship'];
            testWrapper.testContent(done, excludeKeys, {applicationFormPA1A: config.links.applicationFormPA1A});
        });
