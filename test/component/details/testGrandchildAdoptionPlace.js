...
describe('grandchild-adoption-place', () => {
    let testWrapper;
    ...
    beforeEach(() => {
        testWrapper = new TestWrapper('GrandchildAdoptionPlace');
    });
    ...
    describe('Verify Content, Errors and Redirection', () => {
        testCommonContent.runTest('GrandchildAdoptionPlace', null, null, [], false, {type: caseTypes.INTESTACY});
        ...
        it(`test it redirects to any other children page if grandchild is adopted in England or Wales: ${expectedNextUrlForAnyOtherChildren}`, (done) => {
            const sessionData = {
