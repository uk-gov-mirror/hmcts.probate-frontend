...
languages.forEach(language => {
    ...
    Scenario(TestConfigurator.idamInUseText(`${language.toUpperCase()} - GOP Intestacy - Digital iht E2E- @crossbrowser`), async(I) => {
    ...
    Scenario(TestConfigurator.idamInUseText(`${language.toUpperCase()} - GOP Intestacy Child - Paper iht, no death certificate uploaded and spouse renouncing`), async (I) => {
        await I.retry(2).createAUser(TestConfigurator);
