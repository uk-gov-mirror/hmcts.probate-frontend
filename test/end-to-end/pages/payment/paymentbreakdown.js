...
module.exports = async function(language = 'en', paymentNeeded = true) {
    const I = this;
    ...
    if (paymentNeeded) {
        ...
        await I.waitForText(commonContent.submitApplication, testConfig.TestWaitForTextToAppear);
        await I.navByClick(commonContent.submitApplication, 'button.govuk-button');
    }
};
