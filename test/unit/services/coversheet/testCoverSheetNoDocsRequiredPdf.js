...
describe('CoverSheetPdfService', () => {
    describe('post()', () => {
        ...
        it('should call super.post() and call with no docs required and no docs required text if intestacy no docs required conditions met, excepted estate and interim death certificate selected', (done) => {
            const endpoint = 'http://localhost';
            const formdata = {
                caseType: 'intestacy',
                applicant: {
