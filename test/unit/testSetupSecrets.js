...
describe(modulePath, () => {
    ...
    describe('localSecrets', () => {
        ...
        it('should set local config if environment is dev-aat', () => {
            ...
            expect(mockConfig.services.idam.probate_user_email).to.equal('secretValue');
            expect(mockConfig.services.idam.probate_user_password).to.equal('secretValue');
        ...
        it('should not set local config if environment is not dev-aat', () => {
            ...
            expect(mockConfig.services.idam.probate_user_email).to.not.equal('secretValue');
            expect(mockConfig.services.idam.probate_user_password).to.not.equal('secretValue');
