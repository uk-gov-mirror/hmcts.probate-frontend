...
const config = require('app/config'),
    {get, defaultTo} = require('lodash'),
    simpleRandom = require('simple-random');
...
const createPaymentReference = function (data, getCaseReference) {
    ...
    let reference = SERVICE_ID + ID_DELIMITER + getCaseReference(data.deceasedLastName) + ID_DELIMITER +
         SITE_ID + ID_DELIMITER;
...
const createCaseReference = function (deceasedLastName) {
...
module.exports.createPaymentData = createPaymentData;
module.exports.createCaseReference = createCaseReference;
