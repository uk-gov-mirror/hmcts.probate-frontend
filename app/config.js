...
const config = {
    ...
    nonIdamPages: ['stop-page/noWill', 'stop-page/notOriginal', 'stop-page/deathCertificate', 'stop-page/notInEnglandOrWales', 'stop-page/notExecutor', 'stop-page/mentalCapacity', 'stop-page/ihtNotCompleted', 'error', 'sign-in', 'pin-resend', 'pin-sent', 'co-applicant-*', 'pin', 'inviteIdList', 'start-eligibility', 'start-apply', 'new-start-eligibility', 'new-will-left', 'new-will-original', 'new-death-certificate', 'new-deceased-domicile', 'new-applicant-executor', 'new-mental-capacity', 'new-iht-completed', 'new-start-apply'],
    endpoints: {
        health: '/health',
        info: '/info'
    },
