...
router.get('/deceased-address', (req, res, next) => featureToggle.callCheckToggle(req, res, next, res.locals.launchDarkly, 'ft_new_deathcert_flow', featureToggle.toggleFeature));
