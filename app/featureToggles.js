...
router.get('/copies-uk', (req, res, next) => featureToggle.callCheckToggle(req, res, next, res.locals.launchDarkly, 'ft_probate-fee-increase-2025', featureToggle.toggleFeature));
...
router.all('/task-list', (req, res, next) => featureToggle.callCheckToggle(req, res, next, res.locals.launchDarkly, 'ft_stop_ihtonline', featureToggle.toggleFeature));
...
router.all('/certificate-interim', (req, res, next) => featureToggle.callCheckToggle(req, res, next, res.locals.launchDarkly, 'ft_stop_ihtonline', featureToggle.toggleFeature));
router.all('/english-foreign-death-cert', (req, res, next) => featureToggle.callCheckToggle(req, res, next, res.locals.launchDarkly, 'ft_stop_ihtonline', featureToggle.toggleFeature));
router.all('/foreign-death-cert-translation', (req, res, next) => featureToggle.callCheckToggle(req, res, next, res.locals.launchDarkly, 'ft_stop_ihtonline', featureToggle.toggleFeature));
