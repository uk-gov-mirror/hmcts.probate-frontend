...
class ScreenerValidation {
    ...
    getScreeners(journeyType, formdata) {
        const deathCertificateNotInEnglish = formdata && formdata.screeners && formdata.screeners.deathCertificateInEnglish ? formdata.screeners.deathCertificateInEnglish === 'optionNo' : false;
